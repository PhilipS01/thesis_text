...
\usepackage{amsthm}    % \theoremstyle, styled theorem environments
...
\usepackage[record,symbols]{glossaries-extra} % record = bib2gls mode; symbols = creates a dedicated "symbols" glossary

\GlsXtrLoadResources[
	src={symbols},    	% reads symbols.bib
	type=symbols,     	% puts all entries into the symbols glossary
	sort={integer},   	% sort by the numeric sort field below
	selection={all}		% only symbols you actually reference; see note
]
...
\newtheorem{corollary}{Result}[chapter]
...
\begin{document}
	...
	\printunsrtglossary[
		...
		preamble={\noindent Bold symbols denote vectors or matrices, shown in vector notation even where the two-terminal case reduces them to scalars.\bigbreak}
	] % Symbolverzeichnis
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\include{chapters/interface.tex}
