...
\begin{table}[htb]
  ...
  \end{tabular}
  \par\smallskip
  \footnotesize Daten aus \cite{USDRIVE_EDTT}.
\end{table}
...
\end{enumerate}
Xyce\texttrademark is the open-source analogue circuit simulator used in this thesis. It can be replaced by other netlist-driven simulators with little change to the implementation, provided they offer:
\begin{itemize}
	\item Restart/Checkpointing capability
	\item Behavioural source-elements
\end{itemize}
